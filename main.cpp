...
int64 nChainStartTime = 1520755376;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x16add4f3ec258e014abca5f8dbc642a4253b8896362b4ff41c260a4d0005a194"));
